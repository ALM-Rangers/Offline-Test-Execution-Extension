...
function write_ws_xml_dataValidations(dataValidations) {
    if (dataValidations.length == 0) return "";
    var o = '<dataValidations  count="' + dataValidations.length + '">';
    for (var i = 0; i != dataValidations.length; ++i)
        o += '<dataValidation type="' + dataValidations[i].type + '" allowBlank="' + dataValidations[i].allowBlank + '" showInputMessage="' + dataValidations[i].showInputMessage + '" showErrorMessage="' + dataValidations[i].showErrorMessage + '" sqref="' + dataValidations[i].range + '"><formula1>"' + dataValidations[i].formula + ' "</formula1></dataValidation>';
...
function write_ws_xml(idx, opts, wb) {
	...
	if (ws['!dataValidations'] !== undefined && ws['!dataValidations'].length > 0) o[o.length] = (write_ws_xml_dataValidation(ws['!dataValidations']));

	if (o.length > 2) {
	    o[o.length] = ('</worksheet>'); o[1] = o[1].replace("/>", ">");
	}
	return o.join("");
}
